...
public class PlaylistController {
	...
	public ResponseEntity<HttpResponse> getPlaylist(@PathVariable("userId") Long userId) {

		AppServiceResult<Iterable<PlaylistDto>> result = playlistService.getPlaylistByAppUser(userId);
