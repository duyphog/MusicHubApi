...
public class FileConstant {
    ...
    public static final String TRACK_IMGAGE_FOLDER = IMAGE_FOLDER + "songs/";
    ...
    public static final String TRACK_IMAGE_PATH = "/myfile/images/songs/";
    public static final String TRACK_PATH = "/myfile/songs/";
}
